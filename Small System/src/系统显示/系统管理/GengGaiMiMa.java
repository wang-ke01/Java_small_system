...
public class GengGaiMiMa extends JInternalFrame {
	...
	public GengGaiMiMa() {
		...
		addInternalFrameListener(new InternalFrameAdapter() {
			public void internalFrameActivated(final InternalFrameEvent e) {
				userName.setText("<html><b>" + user.getUsername()
						+ "</b></html>");
				name.setText("<html><b>" + user.getName() + "</b></html>");
			}
		});
		setIconifiable(true);
		setClosable(true);
		...
		/*
		 * final JLabel label_4 = new JLabel(); label_4.setFont(new Font("",
		 * Font.PLAIN, 14)); label_4.setForeground(Color.RED);
		 * label_4.setText("<html>注：每个<b>操作员</b>只能修改自己的密码。</html>"); final
		 * GridBagConstraints gridBagConstraints_10 = new GridBagConstraints();
		 * gridBagConstraints_10.weighty = 1.0; gridBagConstraints_10.gridwidth
		 * = 4; gridBagConstraints_10.gridx = 0; gridBagConstraints_10.gridy =
		 * 0; getContentPane().add(label_4, gridBagConstraints_10);
		 */
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				String ns1=new String(newPass1.getPassword());
				String ns2=new String(newPass2.getPassword());
				if (s.equals(user.getPass())) {
					if (ns1.equals(ns2)) {
						user.setPass(ns2);
						DaoRu.updateUser(user);
