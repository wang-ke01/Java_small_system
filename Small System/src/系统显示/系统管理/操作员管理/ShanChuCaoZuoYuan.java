...
public class ShanChuCaoZuoYuan extends JPanel {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				if (op == JOptionPane.OK_OPTION) {
					DaoRu.delete("delete tb_userlist where username='"
							+ loginName.getText().trim()
							+ "'");
					loginName.setText("");
					passField.setText("");
					userName.setText("");
	...
	public void initTable() {
		...
		while (it.hasNext()) {
			...
			data[3] = ((String) userlist.get(3)).equals("a") ? "系统管理员"
					: "普通操作员";
			dftm.addRow(data);
		}
		setVisible(true);
